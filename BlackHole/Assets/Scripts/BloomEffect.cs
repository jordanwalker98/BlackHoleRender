...
//code from here: https://catlikecoding.com/unity/tutorials/advanced-rendering/bloom/
public class BloomEffect : MonoBehaviour {
	...
	public void ProcessBloom (RenderTexture source, RenderTexture destination) {
		if (bloom == null) {
